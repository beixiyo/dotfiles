...
function M.get(c, opts)
  ...
  return {
    ...
    Folded                      = { fg = c.comment, bg = c.none, italic = true }, -- 折叠行：透明底 + 暗灰斜体（参考 Pretty Dark）
    ...
    LspSignatureActiveParameter = { bg = Util.blend_bg(c.bg_visual, 0.7), bold = true },
    ...
    DiagnosticUnnecessary       = { fg = c.dark5 }, -- 未使用的代码：用更暗的灰,降低视觉权重
