...
| Neovim workflow | [Navigation and Search](https://github.com/beixiyo/dotfiles/wiki/nvim-workflow-navigation-and-search) · [vv-explorer File Management](https://github.com/beixiyo/dotfiles/wiki/nvim-workflow-explorer) · [Git Workflow](https://github.com/beixiyo/dotfiles/wiki/nvim-workflow-git) · [Replace and Refactor](https://github.com/beixiyo/dotfiles/wiki/nvim-workflow-replace-and-refactor) · [LSP and Symbols](https://github.com/beixiyo/dotfiles/wiki/nvim-workflow-lsp-and-symbols) · [i18n Workflow](https://github.com/beixiyo/dotfiles/wiki/nvim-workflow-i18n) · [Project Tasks](https://github.com/beixiyo/dotfiles/wiki/nvim-workflow-project-tasks) · [Shortcut Tips](https://github.com/beixiyo/dotfiles/wiki/nvim-guide-shortcut-tips) |
...
| Arch Linux | [Installation](https://github.com/beixiyo/dotfiles/wiki/arch-guide-install) · [Windows Dual Boot](https://github.com/beixiyo/dotfiles/wiki/arch-guide-dual-boot) · [Troubleshooting](https://github.com/beixiyo/dotfiles/wiki/arch-guide-troubleshooting) |
